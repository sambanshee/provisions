...
{% import_yaml 'web/khanifest/wordpress.yaml' as wordpress %}
<?php
/**
...
define('DB_NAME', '{{databases.databases.wordpress.username}}');

/** MySQL database username */
define('DB_USER', '{{databases.databases.wordpress.username}}');
